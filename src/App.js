...
class App extends Component {
  ...
  componentDidMount (){
  let url = "https://newsapi.org/v1/articles?source=ign&sortBy=top&apiKey=bfc8be67bce3411a8962fff243497754";
...
render() {
  return (
    <div className="App row">
      ...
      <Feed infoFeed={this.state.feed} loader={this.state.loader} onClick={this.randomizer}/>
